...
# ============ 可配置参数 ============
MODEL_NAME=${MODEL_NAME:-"llava_v1.5_7b"}        # run.py 的 --model，需与下面 --model-name 一致
MODEL_PATH=${MODEL_PATH:-"/mnt/data/VLM/llava-v1.5-7b"}  # 本地权重路径
...
CACHE_MAX_ENTRY=${CACHE_MAX_ENTRY:-0.5}                   # KV Cache 显存占比（TurboMind：权重外剩余空闲显存的比例）
# ===================================
